...
print('\n-DIGITE AS HORAS NO FORMATO 12H- \n')
...
if h_incial > 12 or h_final > 12 :
    print('\n-INSIRA A HORA NO FORMATO CERTO-')
...
#convertendo tudo pra segundos
 ...
 print(
    f'\nOs dados da viagem são: \ntempo da viagem: {a}s \nVelocidade média geral: {b_global: .2f} Km/h \nVelocidade média em movimento: {b_movimento: .2f} Km/h \nO custo da viagem com combustível: R$ {c: .2f} \nDesempenho do carro: {d_kml: .2f} Km/l, {d_lh: .2f} L/h e {d_rkm: .2f} R$/Km \n'
 )